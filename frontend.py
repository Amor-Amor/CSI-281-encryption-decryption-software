...
top_bar_title = Label(
    top_bar,
    text="Encryption/Decryption GUI",
    font=("courier", 10),
    bg="grey10",
    fg="grey80",
)
...
algorithm_selector_label = Label(
    main_window,
...
text_entry_label = Label(
    main_window, text="Enter Text: ", bg="grey10", fg="grey80", font=("courier", 8)
)
text_entry_label.grid(row=2, column=0, columnspan=1, padx=5, pady=5)

text_entry = Text(
    main_window, height=1, width=20, font=("courier", 8), bg="grey15", fg="grey80"
)
text_entry.grid(row=2, column=1, padx=5, pady=5)

key_entry_label = Label(
    main_window, text="Key: ", bg="grey10", fg="grey80", font=("courier", 8)
)
key_entry_label.grid(row=2, column=2, columnspan=1, padx=5, pady=5)

key_entry = Text(
    main_window, height=1, width=5, bg="grey15", fg="grey80", font=("courier", 8)
)
...
output_label = Label(
    main_window, text="Output: ", bg="grey10", fg="grey80", font=("courier", 8)
)
output_label.grid(row=4, column=0, padx=10, pady=10)

output_box = Text(
    main_window, height=1, width=40, bg="grey15", fg="grey80", font=("courier", 8)
)
